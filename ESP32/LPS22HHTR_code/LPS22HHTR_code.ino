...
LPS22HHSensor lps22hh(&Wire); // Sensor instance
...
void loop() {
    ...
    // Format message as "time;pressure;temperature"
    char message[32];
    snprintf(message, sizeof(message), "%.3f;%.2f;%.2f;", currentTime, pressurePa, temperature);
